...
type Box interface {
	Extent() *BoxExtent
	Draw(page *builder.Builder, xPos, yPos float64)
}
...
func (obj *ruleBox) Draw(page *builder.Builder, xPos, yPos float64) {
...
// Draw implements the [Box] interface.
func (obj Kern) Draw(page *builder.Builder, xPos, yPos float64) {}
...
func (obj raiseBox) Draw(page *builder.Builder, xPos, yPos float64) {
...
// Draw implements the [Box] interface.
func (obj *hBox) Draw(page *builder.Builder, xPos, yPos float64) {
...
func (obj *vBox) Draw(page *builder.Builder, xPos, yPos float64) {
